...
import {SpectrumColumnProps} from '@react-types-nutrient/table';
...
export type {SpectrumColumnProps, TableHeaderProps, TableBodyProps, RowProps, CellProps} from '@react-types-nutrient/table';
