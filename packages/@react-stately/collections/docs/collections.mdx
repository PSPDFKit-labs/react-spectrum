...
import docs from 'docs:@react-stately-nutrient/collections';
import dataDocs from 'docs:@react-stately-nutrient/data';
...
```tsx
import {useTreeData} from '@react-stately-nutrient/data';
...
The <TypeLink links={dataDocs.links} type={dataDocs.exports.useAsyncList} /> hook from `@react-stately-nutrient/data` can be
