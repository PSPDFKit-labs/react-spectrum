...
```
 ...
 - @react-types-nutrient/autocomplete@3.0.0-alpha.11
 - @react-types-nutrient/breadcrumbs@3.4.6
 - @react-types-nutrient/calendar@3.0.5
 - @react-types-nutrient/card@3.0.0-alpha.12
 - @react-types-nutrient/datepicker@3.1.4
 - @react-types-nutrient/link@3.3.6
 - @react-types-nutrient/list@3.1.2
 - @react-types-nutrient/searchfield@3.3.6
 - @react-types-nutrient/table@3.4.0
 - @react-types-nutrient/tag@3.0.0-beta.1
 - @react-types-nutrient/textfield@3.6.2
