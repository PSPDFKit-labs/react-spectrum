...
```
 ...
 - @react-types-nutrient/autocomplete@3.0.0-alpha.19
 - @react-types-nutrient/calendar@3.4.3
 - @react-types-nutrient/card@3.0.0-alpha.22
 - @react-types-nutrient/combobox@3.10.0
 - @react-types-nutrient/datepicker@3.7.1
 - @react-types-nutrient/form@3.7.0
 - @react-types-nutrient/list@3.2.12
 - @react-types-nutrient/radio@3.7.0
 - @react-types-nutrient/select@3.9.1
 - @react-types-nutrient/table@3.9.2
