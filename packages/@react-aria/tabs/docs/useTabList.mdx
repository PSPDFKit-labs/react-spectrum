...
import statelyDocs from 'docs:@react-stately-nutrient/tabs';
import collectionsDocs from 'docs:@react-stately-nutrient/collections';
...
hook in `@react-stately-nutrient/tabs`. The state object should be passed as an option to `useTabList`, `useTab`,
