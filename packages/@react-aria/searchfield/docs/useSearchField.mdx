...
import statelyDocs from 'docs:@react-stately-nutrient/searchfield';
...
hook in `@react-stately-nutrient/searchfield`. The state object should be passed as an option to `useSearchField`.
