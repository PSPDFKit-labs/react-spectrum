...
import statelyDocs from 'docs:@react-stately-nutrient/checkbox';
...
hook in `@react-stately-nutrient/checkbox`. The state object should be passed as an option to `useCheckboxGroup`
