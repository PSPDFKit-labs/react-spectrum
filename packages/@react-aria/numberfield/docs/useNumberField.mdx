...
import statelyDocs from 'docs:@react-stately-nutrient/numberfield';
...
hook from `@react-stately-nutrient/numberfield`. The state object should be passed as an option to `useNumberField`
