...
build('{@react-aria/*,@react-stately-nutrient/*,@react-spectrum/*,react-aria-components}', '@adobe/react-spectrum');
build('{@react-aria/*,@react-stately-nutrient/*,react-aria-components}', 'react-aria-components');
